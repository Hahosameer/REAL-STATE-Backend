...
// CORS Configuration - Fixed for your Live Frontend
app.use(
  cors({
    origin: "https://real-state-ui-omega.vercel.app", // Aapka live frontend URL
    credentials: true,
...
// Health Check (Check karne ke liye ke API chal rahi hai)
app.get("/", (req, res) => {
  res.send("LamaEstate API is running...");
});
